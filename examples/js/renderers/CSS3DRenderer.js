 ...
 */
 ...
 /**
 *此为修改版本，兼容IE10及11，禁止preserve3d渲染时在部分手机上缩放也不会有闪烁的问题。
...
THREE.CSS3DRenderer = function ( parameters ) {
	...
	//是否启用preserve3d渲染。使用.preserve3d，而不要使用._preserve3d。禁止preserve3d渲染手机上不会出现缩放时闪烁现象。
	this._preserve3d = parameters.preserve3d === undefined ? true : parameters.preserve3d; 
	
	//是否排序对象。启用后尽的对象可以遮住远的对象；不启用，会出现远的对象出现在近的对象前面的现象。
